        ...
        <Card className="mt-8 border-primary/30 bg-primary/5">
          <CardContent className="flex flex-col sm:flex-row sm:items-center gap-4 pt-6">
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                Open a free practice room — the real board, chat, and tools, just for you. Play both
                sides and switch between the coach and student views. No sign-up, nothing saved.
              </p>
            </div>
